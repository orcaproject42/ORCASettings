...
public class CreateShortcut extends LauncherActivity {
    ...
    protected Intent getTargetIntent() {
        ...
        targetIntent.addCategory("com.orca.settings.SHORTCUT");
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        shortcutIntent.setClass(getApplicationContext(), OCSettingsActivity.class);
        shortcutIntent.setAction("com.orca.settings.START_NEW_FRAGMENT");
        shortcutIntent.putExtra("orca_fragment_name", intentClass);
    ...
    private int getProperShortcutIcon(String className) {
        ...
        if (c.equals("GeneralUI"))
            return R.drawable.ic_settings_general_ui;
        else if (c.equals("NavigationBar"))
            return R.drawable.ic_settings_navigation_bar;
        else if (c.equals("QuickToggles"))
            return R.drawable.ic_settings_quick_toggles;
        else if (c.equals("StatusBarClock"))
            return R.drawable.ic_settings_clock;
        else if (c.equals("StatusBarSignal"))
            return R.drawable.ic_settings_signal;
        else if (c.equals("PowerMenu"))
            return R.drawable.ic_settings_power_menu;
