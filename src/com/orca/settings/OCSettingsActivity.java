...
public class OCSettingsActivity extends PreferenceActivity implements ButtonBarHandler {

    private static final String TAG = "ORCA_Settings";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if ("com.orca.settings.START_NEW_FRAGMENT".equals(getIntent().getAction())) {
            String className = getIntent().getStringExtra("orca_fragment_name").toString();
            if (!className.equals("com.orca.settings.OCSettingsActivity")) {
                Bundle b = new Bundle();
